...
Variables de entorno y elementos visuales del sitio.
{% /card %}
{% card title="Personalización del tema" href="/es/customizing/theming" icon="🎨" %}
...
{% /card %}
{% card title="SEO y búsqueda con IA" href="/es/customizing/seo" icon="🌐" %}
Metadatos por página, sitemap.xml, robots.txt y llms.txt.
{% /card %}
{% /cards %}
