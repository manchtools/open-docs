...
Variables d'environnement et habillage du site.
{% /card %}
{% card title="Thématisation" href="/fr/customizing/theming" icon="🎨" %}
...
{% /card %}
{% card title="SEO et recherche par IA" href="/fr/customizing/seo" icon="🌐" %}
Métadonnées par page, sitemap.xml, robots.txt et llms.txt.
{% /card %}
{% /cards %}
